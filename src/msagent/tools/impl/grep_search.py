...
from msagent.utils.file import get_file_language
...
async def grep_search(
    ...
    """
    return await _execute_grep_search(
        tool_name=grep_search.name,
...
async def grep(
    ...
    """Search code and filenames, compatible with deepagents-style `grep` usage."""
    return await _execute_grep_search(
        tool_name=grep.name,
        search_query=search_query,
        directory_path=directory_path,
...
GREP_SEARCH_TOOLS = [grep_search, grep]
